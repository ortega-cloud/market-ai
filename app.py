...
# =========================================================
# OBJETIVOS DE ANALISTAS (CON FALLBACK INTEGRADO)
# =========================================================
...
def obtener_objetivos_analistas(ticker, info_dict=None):
    ...
    # FALLBACK: Extraer directamente de info si la API específica falla (Ej: NVDA)
...
if analizar:
    ...
    # Fundamentales (Extracción limpia)
    ...
    # EXTRAER FCF DIRECTO O CALCULADO SI VIENE NULL (Caso NVDA)
