...
# Los imports siempre deben ir arriba del todo en el archivo app.py
...
def calcular_indicadores_historicos(df):
    """
    Calcula indicadores técnicos básicos (RSI, Medias Móviles) sobre el DataFrame histórico.
    """
...
def ejecutar_backtest_engine(
    ...
    """
    Motor completo de Backtesting de MARKET AI.
    """
